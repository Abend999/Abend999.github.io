...
function updateVideo() {
	...
	if (!!video) {
		if (screenWidth < 768) {
			videoSource.src = "Assets/images/Landing page/Video-mobile.mp4"; // Video verticale
		} else {
			videoSource.src = "Assets/images/Landing page/Video-desktop.mp4"; // Video orizzontale
		}
